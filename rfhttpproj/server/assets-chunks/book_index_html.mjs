export default `<!DOCTYPE html><html lang="en" data-beasties-container><head>
  <meta charset="utf-8">
  <title>Rfhttpproj</title>
  <base href="https://kpmmahesh75@gmail.com.github.io/angularWebAPI">
...
</style><link rel="stylesheet" href="styles-ICLARIZ6.css" media="print" onload="this.media='all'"><noscript><link rel="stylesheet" href="styles-ICLARIZ6.css"></noscript></head>
<body>
  <app-root ng-version="19.1.3" ng-server-context="ssg"><router-outlet></router-outlet><!----></app-root>
<script src="polyfills-FFHMD2TL.js" type="module"></script><script src="main-Y6CVK6XK.js" type="module"></script>
